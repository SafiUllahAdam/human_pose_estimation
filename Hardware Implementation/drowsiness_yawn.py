    ...
    for rect in rects:
        ...
        if ear < EYE_AR_THRESH:
            ...
            if COUNTER >= EYE_AR_CONSEC_FRAMES:
                if alarm_status == False:
                    alarm_status = True
                    t = Thread(target=alarm, args=('It seems You are sleeping, Its very dangerous to drive like this. Please Wake up. Please Wakeup',))
                    t.deamon = True
                    t.start()
        ...
        if (distance > YAWN_THRESH):
                ...
                if alarm_status2 == False and saying == False:
                    alarm_status2 = True
                    t = Thread(target=alarm, args=('You seem to be tired. Take some Rest, please',))
                    t.deamon = True
                    t.start()
        else:
            alarm_status2 = False
